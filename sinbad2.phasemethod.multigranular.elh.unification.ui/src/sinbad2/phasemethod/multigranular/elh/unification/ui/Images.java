package sinbad2.phasemethod.multigranular.elh.unification.ui;
...
public class Images {
	...
	private static final String PLUGIN_ID = "sinbad2.phasemethod.multigranular.elh.unification.ui"; //$NON-NLS-1$
