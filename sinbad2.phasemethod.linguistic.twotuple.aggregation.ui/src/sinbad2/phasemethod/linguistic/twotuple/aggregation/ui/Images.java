package sinbad2.phasemethod.linguistic.twotuple.aggregation.ui;
...
public class Images {
	...
	private static final String PLUGIN_ID = "sinbad2.phasemethod.linguistic.twotuple.aggregation.ui"; //$NON-NLS-1$
