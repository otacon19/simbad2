...
public class GLMEditableContentProvider extends KTableNoScrollModel {
	...
	public GLMEditableContentProvider(KTable table, String[] alternatives, String[] criteria, Object[][] values, String titleTable) {
		super(table);
