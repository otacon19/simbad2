		...
		_inRange.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(((Button) e.getSource()).getSelection()) {
					...
					_lowerLimitLabel.setText(Messages.ModifyNumericRealDomainDialog_Lower + " " + Double.toString(Double.NEGATIVE_INFINITY)); //$NON-NLS-2$
					_upperLimitLabel.setText(Messages.ModifyNumericRealDomainDialog_Upper + " -" + Double.toString(Double.POSITIVE_INFINITY)); //$NON-NLS-2$
