...
public class ModifyNumericRealDomainDialog extends ModifyDomainDialog {
	...
	public ModifyNumericRealDomainDialog() {
		super();
	}
	...
	public void setDomain(Domain domain) {
		...
		_specificDomain = (NumericRealDomain) _newDomain;
	...
	protected Control createDialogArea(Composite parent) {
		...
		idLabel.setText(Messages.ModifyNumericRealDomainDialog_Domain_id);
		...
		titleLabel.setText(Messages.ModifyNumericRealDomainDialog_Limits);
		
		_lowerLimitLabel = new Label(_container, SWT.NONE);
		gridData = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
		_lowerLimitLabel.setLayoutData(gridData);
		_lowerLimitLabel.setText(Messages.ModifyNumericRealDomainDialog_Lower);
		...
		_inRange.setText(Messages.ModifyNumericRealDomainDialog_Without_range);
		...
		_upperLimitLabel.setText(Messages.ModifyNumericRealDomainDialog_Upper);
		...
		previewLabel.setText(Messages.ModifyNumericRealDomainDialog_Preview);
		...
		_inRange.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(((Button) e.getSource()).getSelection()) {
					...
					_lowerLimitLabel.setText(Messages.ModifyNumericRealDomainDialog_Lower + " " + Double.toString(Double.NEGATIVE_INFINITY)); //$NON-NLS-2$ //$NON-NLS-1$ //$NON-NLS-1$
					_upperLimitLabel.setText(Messages.ModifyNumericRealDomainDialog_Upper + " -" + Double.toString(Double.POSITIVE_INFINITY)); //$NON-NLS-2$ //$NON-NLS-1$ //$NON-NLS-1$
	...
	protected void validate() {
		...
		if(!_id.isEmpty()) {
			if(_ids.contains(_id)) {
				message = Messages.ModifyNumericRealDomainDialog_Duplicated_id;
			}
		} else {
			message = Messages.ModifyNumericRealDomainDialog_Empty_value;
		}
