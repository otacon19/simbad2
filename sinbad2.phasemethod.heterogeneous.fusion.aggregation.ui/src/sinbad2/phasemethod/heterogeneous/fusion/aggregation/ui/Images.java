package sinbad2.phasemethod.heterogeneous.fusion.aggregation.ui;
...
public class Images {
	...
	private static final String PLUGIN_ID = "sinbad2.phasemethod.heterogeneous.fusion.aggregation.ui"; //$NON-NLS-1$
