package sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view;
...
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.Images;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.editingsupport.AggregationOperatorEditingSupport;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.editingsupport.OperatorWeightsEditingSupport;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.provider.AggregationCriterionViewerContentProvider;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.provider.AggregationExpertViewerContentProvider;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.provider.AlternativeColumnLabelProvider;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.provider.ElementColumnLabelProvider;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.provider.EvaluationColumnLabelProvider;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.provider.OperatorColumnLabelProvider;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.provider.RankingColumnLabelProvider;
import sinbad2.phasemethod.unbalanced.methodology.aggregation.ui.view.provider.RankingViewerProvider;
...
public class AggregationProcess extends ViewPart implements AggregationProcessListener, IStepStateListener {
	...
	public static final String ID = "flintstones.phasemethod.unbalanced.methodology.aggregation.ui.view.aggregationprocess";
	...
	private Unbalanced getDomain() {
		return _unificationPhase.getDomainLH();
	}
	...
	private void testAggregationProcess() {
		_unificationPhase.unification((Unbalanced) getDomain());
