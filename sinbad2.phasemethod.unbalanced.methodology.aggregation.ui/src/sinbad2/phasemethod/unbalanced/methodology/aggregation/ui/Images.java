package sinbad2.phasemethod.unbalanced.methodology.aggregation.ui;
...
public class Images {
	...
	private static final String PLUGIN_ID = "sinbad2.phasemethod.unbalanced.methodology.aggregation.ui"; //$NON-NLS-1$
