		...
		_inRange.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(((Button) e.getSource()).getSelection()) {
					...
					_lowerLimitLabel.setText(Messages.ModifyNumericIntegerDomainDialog_Lower + " " + Double.toString(Double.NEGATIVE_INFINITY)); //$NON-NLS-2$ //$NON-NLS-1$
					_upperLimitLabel.setText(Messages.ModifyNumericIntegerDomainDialog_Upper + " " + Double.toString(Double.POSITIVE_INFINITY)); //$NON-NLS-2$ //$NON-NLS-1$
