package sinbad2.resolutionphase.rating.ui.nls;
...
public class Messages extends NLS {
	...
	public static String AlgorithmDialog_Hesitant_Fuzzy_Linguistic_Term_Set;
	public static String AlgorithmDialog_Interactive_and_multicriteria_decision_making;
	...
	public static String RatingView_Method_colon;
	public static String RatingView_Method_description;
	public static String RatingView_Method_phases;
	public static String RatingView_Method_selection;
	public static String RatingView_Next;
	public static String RatingView_Not_set_all_assignments;
	public static String RatingView_Reset;
	public static String RatingView_Show_algorithm;
	public static String RatingView_Step;
	public static String RatingView_SUITABLE;
	public static String RatingView_Unselected;
	static {
