package sinbad2.phasemethod.heterogeneous.fusion.unification.ui;
...
public class Images {
	...
	private static final String PLUGIN_ID = "sinbad2.phasemethod.heterogeneous.fusion.unification.ui"; //$NON-NLS-1$
