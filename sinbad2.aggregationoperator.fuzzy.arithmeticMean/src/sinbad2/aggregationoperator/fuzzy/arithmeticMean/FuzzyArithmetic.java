package sinbad2.aggregationoperator.fuzzy.arithmeticMean;

import java.util.LinkedList;
import java.util.List;

import sinbad2.aggregationoperator.UnweightedAggregationOperator;
import sinbad2.aggregationoperator.fuzzy.arithmeticMean.valuation.HesitantTwoTupleOperator;
import sinbad2.core.validator.Validator;
import sinbad2.valuation.Valuation;
import sinbad2.valuation.elicit.ELICIT;

public class FuzzyArithmetic extends UnweightedAggregationOperator {

	public static final String ID = "flintstones.aggregationoperator.fuzzy.arithmeticmean"; //$NON-NLS-1$
