...
import flintstones.resolutionscheme.state.EResolutionSchemeStateChanges;
...
public class ResolutionScheme {
	...
	public ResolutionScheme(String id, String name, ResolutionSchemeImplementation implementation, List<ResolutionPhase> phases, 
	...
	public ResolutionSchemeImplementation getImplementation() {
		if(_implementation == null) {
			try {
				_implementation= (ResolutionSchemeImplementation) _registry.getConfiguration().createExecutableExtension(
						EResolutionSchemeElements.implementation.toString());
	...
	public void activate() {
		...
		notifyResolutionSchemeStateChange(new ResolutionSchemeStateChangeEvent(EResolutionSchemeStateChanges.ACTIVATED));
	}
	...
	public void deactivate() {
		...
		notifyResolutionSchemeStateChange(new ResolutionSchemeStateChangeEvent(EResolutionSchemeStateChanges.DEACTIVATED));
	}
	
	
	public void registerResolutionSchemeStateListener(IResolutionSchemeStateListener listener) {
		_listeners.add(listener);
	}
	
	public void unregisterResolutionSchemeStateListener(IResolutionSchemeStateListener listener) {
