...
public abstract class ExcelWriter {
	 ...
	 * @throws IOException
	 *             Si existe alg�n error accediendo al archivo.
	 * @throws WriteException
	 *             Si existe alg�n error de escritura.
	 */
	 ...
	 * @throws WriteException
	 *             Si existe alg�n error escribiendo la hoja.
	 */
	 ...
	 * @throws WriteException
	 *             Si existe alg�n problema asociado a la escritura del archivo.
	 * @throws RowsExceededException
	 *             Si alguna fila sobrepasa los l�mites.
	 */
	protected abstract void createContent(WritableWorkbook workbook) throws WriteException, RowsExceededException ;

	/**
	 * Crea la informaci�n del problema.
	 * 
	 * @param workbook
	 *            Libro en que crear la informaci�n del problema.
	 * @throws WriteException
	 *             Si existe alg�n problema escribiendo la informaci�n del
	 *             problema.
	 */
	 ...
	 * 
	 * @throws WriteException
	 *             Si existe alg�n problema creado los formatos.
	 */
	...
	/**
	 * A�ade una evaluaci�n unificada.
	 * 
	 * @param sheet
	 *            Hoja en la que insertar la evaluaci�n.
	 * @param pos
	 *            Posici�n de inserci�n
	 * @param valuation
	 *            Evaluaci�n a insertar.
	 * @throws RowsExceededException
	 *             Si la fila de insercci�n excede el n�mero de filas.
	 * @throws WriteException
	 *             Si existe alg�n error de escritura.
	 */
	...
	/**
	 * A�ade una evaluaci�n dos tuplas.
	 * 
	 * @param sheet
	 *            Hoja en la que insertar la evaluaci�n.
	 * @param pos
	...
	/**
	 * A�ade el valor delta de una evaluaci�n dos tuplas
	 * 
	 * @param sheet
	 *            Hoja en la que insertar la evaluaci�n.
	 * @param pos
	...
	/**
	 * A�ade una evaluaci�n num�rica.
	 * 
	 * @param sheet
	 *            Hoja en la que insertar la celda.
	 * @param pos
	 *            Posici�n en la que insertar la celda.
	 * @param domain
	 *            Dominio de la evaluaci�n.
	 * @param domainName
	 *            Nombre del dominio de la evaluaci�n.
	 * @param valuation
	 *            Valor de la evaluaci�n.
	 * @throws RowsExceededException
	 *             Si la linea de inserci�n excede el n�mero de filas.
	 * @throws WriteException
	 *             Si existe alg�n error de escritura en el archivo.
	 */
	...
	/**
	 * A�ade una evaluaci�n ling��stica.
	 * 
	 * @param sheet
	 *            Hoja en la que insertar la evaluaci�n.
	 * @param pos
	 *            Posici�n en la que insertar la evaluaci�n.
	 * @param domain
	 *            Dominio de la evaluaci�n.
	 * @param domainName
	 *            Nombre del dominio de la evaluaci�n.
	...
	/**
	 * A�ade una evaluaci�n intervalar.
	 * 
	 * @param sheet
	 *            Hoja en la que insertar la evaluaci�n.
	 * @param pos
	...
	/**
	 * A�ade una celda de t�tulo.
	 * 
	 * @param sheet
	 *            Hoja en la que insertar el t�tulo.
	 * @param column
	 *            Columna en la que insertar el t�tulo.
	 * @param row
	 *            Fila en la que insertar el t�tulo.
	 * @param s
	 *            Texto a insertar.
	...
	/**
	 * A�ade una celda con texto en blanco.
	 * 
	 * @param sheet
	...
	/**
	 * A�ade una etiqueta de evaluaci�n.
	 * 
	 * @param sheet
	 *            Hoja en la que insertar la evaluaci�n.
	 * @param column
