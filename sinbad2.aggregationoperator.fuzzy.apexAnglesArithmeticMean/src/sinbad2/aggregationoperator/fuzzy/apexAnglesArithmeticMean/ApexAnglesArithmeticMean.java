package sinbad2.aggregationoperator.fuzzy.apexAnglesArithmeticMean;

import java.util.LinkedList;
import java.util.List;

import sinbad2.aggregationoperator.UnweightedAggregationOperator;
import sinbad2.aggregationoperator.fuzzy.apexAnglesArithmeticMean.valuation.HesitantTwoTupleOperator;
import sinbad2.core.validator.Validator;
import sinbad2.valuation.Valuation;
import sinbad2.valuation.hesitant.twoTuple.HesitantTwoTupleValuation;

public class ApexAnglesArithmeticMean extends UnweightedAggregationOperator {
	
public static final String ID = "flintstones.aggregationoperator.fuzzy.apexAnglesArithmetic"; //$NON-NLS-1$
