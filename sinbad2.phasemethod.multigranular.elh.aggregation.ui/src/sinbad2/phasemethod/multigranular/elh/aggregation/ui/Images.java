package sinbad2.phasemethod.multigranular.elh.aggregation.ui;
...
public class Images {
	...
	private static final String PLUGIN_ID = "sinbad2.phasemethod.multigranular.elh.aggregation.ui"; //$NON-NLS-1$
