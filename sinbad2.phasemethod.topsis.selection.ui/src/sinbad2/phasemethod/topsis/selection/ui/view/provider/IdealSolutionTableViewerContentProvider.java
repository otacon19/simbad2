...
public class IdealSolutionTableViewerContentProvider implements IStructuredContentProvider {
	...
	private List<Object[]> _idealSolutionData;
	...
	public IdealSolutionTableViewerContentProvider() {
		_idealSolutionData = new LinkedList<Object[]>();
	...
	public void setInput(List<TwoTuple> noIdealSolution) {
		...
		for(int i = 0; i < noIdealSolution.size(); ++i) {
			...
			_idealSolutionData.add(data);
		}

		Collections.sort(_idealSolutionData, new DataComparator());
	}
	
	public List<Object[]> getInput() {
		return _idealSolutionData;
	}
