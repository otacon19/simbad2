...
public class ExpertsWeightContentProvider extends KTableNoScrollModel  {
	...
	private static final String EXPERT_ABBREVIATION_PREFIX = "e";
	private static final String CRITERION_ABBREVIATION_PREFIX = "c";
	...
	private Object criterionAbbreviation(int pos) {
		return CRITERION_ABBREVIATION_PREFIX + pos;
	}
	
	private Object expertAbbreviation(int pos) {
		return EXPERT_ABBREVIATION_PREFIX + pos;
	}
