package sinbad2.phasemethod.todim.unification.ui.view;
...
import sinbad2.phasemethod.todim.unification.ui.view.provider.AlternativeColumnLabelProvider;
import sinbad2.phasemethod.todim.unification.ui.view.provider.CriterionColumnLabelProvider;
import sinbad2.phasemethod.todim.unification.ui.view.provider.DomainColumnLabelProvider;
...
public class Unification extends ViewPart implements IStepStateListener {
	...
	public static final String ID = "flintstones.phasemethod.todim.unification.ui.view.unification"; //$NON-NLS-1$
