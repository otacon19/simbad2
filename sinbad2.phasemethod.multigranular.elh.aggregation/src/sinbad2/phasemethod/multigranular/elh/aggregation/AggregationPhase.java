package sinbad2.phasemethod.multigranular.elh.aggregation;
...
import sinbad2.phasemethod.multigranular.elh.aggregation.listener.EAggregationProcessStateChange;
...
public class AggregationPhase implements IPhaseMethod {
	...
	public static final String ID = "flintstones.phasemethod.multigranular.elh.aggregation";
	...
	private ProblemElement[] setOperator(ProblemElement element, AggregationOperator operator, Object weights, Map<ProblemElement, Object> weightsMap, Map<ProblemElement, AggregationOperator> operators, String elementType) {
		...
		} else if (elementType.equals("criterion")) {
