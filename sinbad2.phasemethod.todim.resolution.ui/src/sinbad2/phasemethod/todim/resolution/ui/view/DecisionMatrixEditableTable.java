...
import sinbad2.phasemethod.todim.resolution.ui.view.provider.DMEditableTableContentProvider;

public class DecisionMatrixEditableTable extends KTable {
	
	private DMEditableTableContentProvider _dmTableContentProvider;
	
	private boolean _completed = false;
	
	public DecisionMatrixEditableTable(Composite parent) {
	...
	public void setModel(String[] alternatives, String[] criteria, Object[][] values) {
		...
		_dmTableContentProvider = new DMEditableTableContentProvider(this, alternatives, criteria, values);
