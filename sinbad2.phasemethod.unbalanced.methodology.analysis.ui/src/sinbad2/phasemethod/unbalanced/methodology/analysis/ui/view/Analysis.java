package sinbad2.phasemethod.unbalanced.methodology.analysis.ui.view;
...
import sinbad2.phasemethod.unbalanced.methodology.analysis.ui.view.provider.EvaluationColumnLabelProvider;
import sinbad2.phasemethod.unbalanced.methodology.analysis.ui.view.provider.FilterContentProvider;
import sinbad2.phasemethod.unbalanced.methodology.analysis.ui.view.provider.FilterLabelProvider;
import sinbad2.phasemethod.unbalanced.methodology.analysis.ui.view.provider.RankingColumnLabelProvider;
import sinbad2.phasemethod.unbalanced.methodology.analysis.ui.view.provider.RankingViewerProvider;
...
public class Analysis extends ViewPart implements IStepStateListener {
	...
	public static final String ID = "flintstones.phasemethod.unbalanced.methodology.analysis.ui.view.analysis";
	...
	private Unbalanced getDomain() {
		return (Unbalanced) _aggregationPhase.getUnifiedDomain();
	}
