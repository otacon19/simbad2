...
import sinbad2.phasemethod.linguistic.elicit.unification.ui.Images;
import sinbad2.phasemethod.linguistic.elicit.unification.ui.nls.Messages;
import sinbad2.phasemethod.linguistic.elicit.unification.ui.view.comparator.UnificationTreeViewerComparator;
import sinbad2.phasemethod.linguistic.elicit.unification.ui.view.provider.AlternativeColumnLabelProvider;
import sinbad2.phasemethod.linguistic.elicit.unification.ui.view.provider.CriterionColumnLabelProvider;
import sinbad2.phasemethod.linguistic.elicit.unification.ui.view.provider.DomainColumnLabelProvider;
import sinbad2.phasemethod.linguistic.elicit.unification.ui.view.provider.EvaluationColumnLabelProvider;
import sinbad2.phasemethod.linguistic.elicit.unification.ui.view.provider.ExpertColumnLabelProvider;
import sinbad2.phasemethod.linguistic.elicit.unification.ui.view.provider.TreeViewerContentProvider;
import sinbad2.phasemethod.linguistic.elicit.unification.ui.view.provider.UnifiedEvaluationColumnLabelProvider;
...
public class Unification extends ViewPart implements IStepStateListener {
	...
	public static final String ID = "flintstones.phasemethod.multigranular.elh.unification.ui.view.unification"; //$NON-NLS-1$
	...
	private void createEvaluationsTable() {
		...
		TreeViewerContentProvider provider = new TreeViewerContentProvider(_unifiedValues, _unificationPhase.getFuzzyNumbers());
