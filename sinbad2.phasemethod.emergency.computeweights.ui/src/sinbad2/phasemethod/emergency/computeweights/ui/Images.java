package sinbad2.phasemethod.emergency.computeweights.ui;
...
public class Images {
	...
	private static final String PLUGIN_ID = "sinbad2.phasemethod.emergency.computeweights.ui"; //$NON-NLS-1$
