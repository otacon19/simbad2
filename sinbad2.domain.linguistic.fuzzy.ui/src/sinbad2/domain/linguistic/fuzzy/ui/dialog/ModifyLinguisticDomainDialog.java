...
public class ModifyLinguisticDomainDialog extends ModifyDomainDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		idLabel.setText(Messages.ModifyLinguisticDomainDialog_Domain_id);
		...
		_labels.setText(Messages.ModifyLinguisticDomainDialog_Labels);
		...
		_tableViewerNameCol.getColumn().setText(Messages.ModifyLinguisticDomainDialog_Name);
		...
		_tableViewerSemanticCol.getColumn().setText(Messages.ModifyLinguisticDomainDialog_Semantic);
		...
		_previewLabel.setText(Messages.ModifyLinguisticDomainDialog_Preview);
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(Messages.ModifyLinguisticDomainDialog_Manually_create_domain);
	}
	...
	private void validate() {		
		...
		if(!_id.isEmpty()) {
			if(_ids.contains(_id)) {
				msgId = Messages.ModifyLinguisticDomainDialog_Duplicated_id;
			}
		} else {
				msgId = Messages.ModifyLinguisticDomainDialog_Empty_value;
		}
