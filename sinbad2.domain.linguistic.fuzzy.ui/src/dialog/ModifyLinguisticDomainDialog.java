	...
	protected Control createDialogArea(Composite parent) {
		...
		_container.addPaintListener(new PaintListener() {
			...
			public void paintControl(PaintEvent e) {
				((Button) _addButton.getWidget()).setSize(83, 33);
				((Button) _modifyButton.getWidget()).setSize(83, 33);
			}
		});
		...
		GridData gd_tableViewerComposite = new GridData(SWT.CENTER, SWT.CENTER, false, false, 2, 1);
