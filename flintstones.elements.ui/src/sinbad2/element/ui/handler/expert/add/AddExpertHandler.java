...
public class AddExpertHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		AddExpertInputDialog dialog = new AddExpertInputDialog(Display.getCurrent().getActiveShell(), 
				Messages.AddExpertHandler_Add_expert, Messages.AddExpertHandler_Insert_id_expert, "", new AddExpertInputValidator(parent, elementSet), parent); //$NON-NLS-3$ //$NON-NLS-1$ //$NON-NLS-1$ //$NON-NLS-1$ //$NON-NLS-1$
